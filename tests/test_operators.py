...
def test_sigmoid(a):
    ...
    * it is  strictly increasing.
    """
    # Need to Implement the 2nd and 4th Assertion #
    sigmoid_out = sigmoid(a)
    assert sigmoid_out >= 0 and sigmoid_out <= 1
    # assert (1-sigmoid_out) == -sigmoid_out
    if (a > 0):
        assert sigmoid_out > 0.5 
...
@pytest.mark.task0_2
@pytest.mark.skip(reason="Will think of things later")
def test_other():
    """
